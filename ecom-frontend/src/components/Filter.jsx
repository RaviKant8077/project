...
const Filter = ({categories}) => {
   /* const categories = [
        {categoryId:1, categoryName:"Lofer"},
        {categoryId:2, categoryName:"SmartPhones"},
        {categoryId:3, categoryName:"CarCollection"},
        {categoryId:4, categoryName:"Laptops"},
        {categoryId:5, categoryName:"SmartTV's"},
];
*/
...
return(
    <div className="flex lg:flex-row flex-col-reverse lg:justify-between justify-center items-center gap-4">
      <div className="relative flex items-center 2xl:w-[450px] sm:w-[420px] w-full ">
        ...
        className="border border-gray-400 text-slate-800 rounded-md py-2 pl-10 pr-4 w-full focul:outline-none focus:ring-2 focus:ring-[#1976d2]" />
      ...
      <div className="flex sm:flex-row flex-col gap-4 items-center">
          ...
          <Tooltip title="Sorted by Price : asc">
            <Button
             variant="contained"
             color="primary" 
             className="flex text-center gap-2 h-10"
             onClick={toggleSortOrder}>
                SortBy 
                {sortOrder === "asc" ? (<FiArrowUp size={20}/>) : (<FaArrowDown />)}
...
//categories && Array.isArray(categories) ? : <p>Loading categories...</p>